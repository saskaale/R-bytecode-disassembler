...
code <- c("GETVAR type", "SWITCH switch(type, mean = 1, median = 2, trimmed = 3) | c(\"mean\", \"median\", \"trimmed\", \"\") | $2, $3, $4, $1 | $2, $3, $4, $1",
        "1:", "LDNULL", "INVISIBLE", "RETURN", "2:", "LDCONST 1", "RETURN",
        "3:", "LDCONST 2", "RETURN", "4:", "LDCONST 3", "RETURN")
stopifnot(eqOut(operands(out), code))
